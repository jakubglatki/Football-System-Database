...
-- -----------------------------------------------------
-- Table `mydb`.`MainCoach`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`MainCoach` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Coach_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_MainCoach_Coach1_idx` (`Coach_id` ASC) VISIBLE,
  CONSTRAINT `fk_MainCoach_Coach1`
    FOREIGN KEY (`Coach_id`)
    REFERENCES `mydb`.`Coach` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`AssistantCoach`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AssistantCoach` (
  `id` INT NOT NULL,
  `Coach_id` INT NOT NULL,
  `role` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_AssistantCoach_Coach1_idx` (`Coach_id` ASC) VISIBLE,
  CONSTRAINT `fk_AssistantCoach_Coach1`
    FOREIGN KEY (`Coach_id`)
    REFERENCES `mydb`.`Coach` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`GoalkeeperCoach`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`GoalkeeperCoach` (
  `id` INT NOT NULL,
  `Coach_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_GoalkeeperCoach_Coach1_idx` (`Coach_id` ASC) VISIBLE,
  CONSTRAINT `fk_GoalkeeperCoach_Coach1`
    FOREIGN KEY (`Coach_id`)
    REFERENCES `mydb`.`Coach` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
